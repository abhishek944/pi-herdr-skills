...
Uses `@property` to animate a custom property as an integer, then display it via `counter()`. No JS required. Require browser support for `@property` when using this pattern.
